...
$result = $mysqli->query(
    "SELECT uid, name, student_id, NULL AS faculty_id, NULL AS staff_id,
         ...
         phone, NULL AS purpose, NULL AS valid_until, 'student' AS role
     FROM students
     UNION ALL
     SELECT uid, name, NULL, faculty_id, NULL,
         NULL, NULL, NULL, department,
         phone, NULL, NULL, 'faculty' AS role
     FROM faculty
     UNION ALL
     SELECT uid, name, NULL, NULL, staff_id,
         NULL, NULL, NULL, department,
         phone, NULL, NULL, 'staff' AS role
     FROM staff
     UNION ALL
     SELECT uid, name, NULL, NULL, NULL,
         NULL, NULL, NULL, NULL,
         phone, purpose, valid_until, 'visitor' AS role
     FROM visitors
     ORDER BY name ASC"
);
